...
const testimonials = [
    ...
    {
        text: "“These AI tools have completely revolutionized our Galactica entire strategy overnight”",
        ...
        <>
            <section className={"py-20 md:py-24"}>
                <div className={"container"}>
                    ...
                    <p className={"text-white/70 text-lg md:text-xl max-w-2xl mx-auto text-center tracking-tight mt-5"}>Our revolutionary AI Galactica tools have transformed our clients&apos; strategies.</p>
